...
template<typename Real, typename Scalar>
Scalar biform_0_1(int n, double *wt, Func<Real> *u, Func<Real> *v, Geom<Real> *e, ExtData<Scalar> *ext)
{
	int m = e->marker - 1;
...
Ord liform_0_ord(int n, double *wt, Func<Ord> *v, Geom<Ord> *e, ExtData<Ord> *ext)
{
...
// Integration order for the volumetric linear form
Ord liform_1_ord(int n, double *wt, Func<Ord> *v, Geom<Ord> *e, ExtData<Ord> *ext)
{
  return 10+v->val[0].get_order();  // returning the polynomial degree of the test function plus two
}
