...
int main(int argc, char* argv[])
{
  ...
  WeakForm wf(2);
  wf.add_biform(0, 0, jac_TT, jac_TT_ord, UNSYM, ANY, 1, &T_prev_newton);
  wf.add_biform(0, 1, jac_Tphi, jac_Tphi_ord, UNSYM, ANY, 0);
  wf.add_liform(0, res_T, res_T_ord, ANY, 3, &T_prev_newton, &T_prev_time, &phi_prev_newton);
  wf.add_biform(1, 0, jac_phiT, jac_phiT_ord, UNSYM, ANY, 2, &phi_prev_newton, &T_prev_newton);
  wf.add_biform(1, 1, jac_phiphi, jac_phiphi_ord, UNSYM, ANY, 1, &T_prev_newton);
  wf.add_liform(1, res_phi, res_phi_ord, ANY, 3, &phi_prev_newton, &phi_prev_time, &T_prev_newton);
