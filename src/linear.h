...
// $Id: linear.h 1086 2008-10-21 09:05:44Z jakub $
...
const double EPS_LOW    = 0.0014;
const double EPS_NORMAL = 0.0008;
const double EPS_HIGH   = 0.0003;
...
public:
  ...
  void process_solution(MeshFunction* sln, int item = FN_VAL_0,
                        double eps = EPS_NORMAL, double max_abs = -1.0,
