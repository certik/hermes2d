...
public:
  ...
  ~AutoLocalArray() { delete[] arr; arr = 0; };
};
...
{
public:
  AutoLocalClassArray(T* arr, int length) : AutoLocalArray(arr, length) {};
  ~AutoLocalClassArray() { delete[] arr; arr = 0; }
};
...
public:
  ...
  ~AutoLocalArray2() { delete[] arr; arr = 0; };
};
