...
static void add_built_in(const char* name, MSymbolFunc1* fn) { add_built_in(name, fn, 1); }
static void add_built_in(const char* name, MSymbolFunc2* fn) { add_built_in(name, fn, 2); }
