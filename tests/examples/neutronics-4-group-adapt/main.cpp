...
/** \addtogroup t_bench_neutronics_4g Benchmarks/Neutronics 4-group
 *  \{
 *  \brief This test makes sure that the benchmark "neutronics-4-group-adapt" works correctly.
 *
...
#define ERROR_FAILURE                               -1
  int n_dof_1 = spaces[0]->get_num_dofs(),
      n_dof_2 = spaces[1]->get_num_dofs(),
      n_dof_3 = spaces[2]->get_num_dofs(),
      n_dof_4 = spaces[3]->get_num_dofs();
  ...
  printf("n_dof_actual  = %d, %d, %d, %d\n", n_dof_1, n_dof_2, n_dof_3, n_dof_4);
  printf("n_dof_allowed = %d, %d, %d, %d\n", n_dof_1_allowed, n_dof_2_allowed, n_dof_3_allowed, n_dof_4_allowed);
  ...
  if (   n_dof_1 <= n_dof_1_allowed && n_dof_2 <= n_dof_2_allowed
      && n_dof_3 <= n_dof_3_allowed && n_dof_4 <= n_dof_4_allowed) {
    printf("Success!\n");
