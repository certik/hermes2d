...
:INTTP_FOUND
        ...
        if exist config.h goto CONFIG_FOUND
	echo A file 'config.h' not found. Script not executed in MSVC2008 directory. Please, copy contents of a directory 'MSVC2008' to hermes2d and run the script 'prepare_dep_dir.bat'.
	goto END
...
:CREATE_DIR
	...
	copy %PDD_OLD_DIR%\config.h %PDD_OLD_DIR%\..\src\
	cd ..	
